...
const brands: Brand[] = [
  ...
  { name: "Claro Colombia", category: "Patrocinador principal", color: "#6EF9F4", size: "md" },
  { name: "Bancolombia", category: "Patrocinador financiero", color: "#6023CD", size: "md" },
  { name: "Cinépolis", category: "Aliado cinematográfico", color: "#8D3EF6", size: "md" },
  { name: "Adobe", category: "Herramientas creativas", color: "#6EF9F4", size: "sm" },
  { name: "DJI Colombia", category: "Equipos audiovisuales", color: "#6023CD", size: "sm" },
  { name: "Sony Music", category: "Música y sonido", color: "#8D3EF6", size: "sm" },
  { name: "Cámara de Comercio", category: "Aliado institucional", color: "#6EF9F4", size: "sm" },
  { name: "EPM", category: "Patrocinador energía", color: "#6023CD", size: "sm" },
  { name: "Spotify for Artists", category: "Plataforma musical", color: "#8D3EF6", size: "sm" },
  { name: "Festival Iberoamericano", category: "Aliado cultural", color: "#6EF9F4", size: "sm" },
];
